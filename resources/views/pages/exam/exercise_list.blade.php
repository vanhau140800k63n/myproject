                ...
                <a class="--track e-hover-grow" href="{{ route('exam.get_exercise_info', ['language' => $key]) }}">
                    ...
                    <div class="--info">
                        ...
                        <div class="--last-touched">
                            ...
                            <button class="--btn" style="background-image: radial-gradient( circle 588px at 31.7% 40.2%,  rgba(225,200,239,1) 21.4%, rgba(163,225,233,1) 57.1% ); margin-left: 5px">{{ $exam['name'] }} nâng cao</button>
                        </div>
                    </div>
                </a>
            @endforeach
