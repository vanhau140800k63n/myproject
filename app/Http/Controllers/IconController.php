...
class IconController extends Controller
{
    ...
    public function getIconHome()
    {
        ...
        $iconList = $this->iconRepository->searchIconByKey($word);

        $color_filters = CommonConstants::COLER_FILTERS;
        $shape_filters =  CommonConstants::SHAPE_FILTERS;

        return view('pages.icon.list', compact('iconList', 'color_filters', 'shape_filters', 'word', 'filter_selected', 'crr_page', 'page_total'));
    }
    ...
    public function searchIcon(Request $req)
    {
        ...
        return view('pages.icon.list', compact('iconList', 'color_filters', 'shape_filters', 'word', 'filter_selected', 'page_total', 'crr_page'));
    }
